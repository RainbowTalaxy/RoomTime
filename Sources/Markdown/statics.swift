...
extension Markdown {
    ...
    public static let lineRegexOption: NSRegularExpression.Options = [.anchorsMatchLines]
    ...
    public static let defaultSplitRules: [SplitRule] = [
...
//        LineSplitRule(priority: 4)
    ...
    public static let defaultMapRules: [MapRule] = [
